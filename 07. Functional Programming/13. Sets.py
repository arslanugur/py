...
# PS:"I'm a beginner" import time my_list = [1,3,3.14,"Vas","dBy"] tic1 = time.time() 
# starting time print(3.14 in my_list) tac1 = time.time() #ending time print(tac1 - tic1) 
# total duration of execution my_set = set(my_list) tic2 = time.time() print(3.14 in my_set) tac2 = time.time() print(tac2 - tic2) OUTPUT True 8.344650268554688e-6 
...
scipbel
https://code.sololearn.com/ctn24YbpvR93/
  Subhash Kapil
[ ] = list ( ) = tuple { } = set { } = dictionary ( remember it is with key : value pair) Also, {} = empty dictionary set() = empty set
