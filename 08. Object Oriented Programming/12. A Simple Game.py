...
# (2): Thanks to the reply of Jonathon McEwan to the question comment of Egildio Nham, I luckily managed to figure out that the verb_dict is a dictionary that's DEFINED towards the BOTTOM of the code!!! What a pain - I was reading the code from top to bottom, that's why, so got confused 😔. 
