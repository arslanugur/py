#You simply need to enter your city name as a input to see the full weather details	
#Note : See the output in landscape mode to see the better view of output
...
print ("see the output in landscape view\n\n")
