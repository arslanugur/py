...
Also, regarding the last 2 bits of the lesson, I suspect a hopefully decent example is the following.
...
I highly recommend everybody to install AutoPEP8 so your code will be scanned real time as you write it and you will receive recommendations what and how you should change. This way you will always create readable, consistent and nice code without thinking about how to do it.
